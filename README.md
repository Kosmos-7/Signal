...
- [portfolio_agent.py](portfolio_agent.py) — agent Claude 2 passes (Haiku analyse → Sonnet décisions) + règles non négociables (stop-loss R07/R08, mode panique, concentration sectorielle, weekend)
